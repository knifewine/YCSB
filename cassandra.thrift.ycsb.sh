...
use usertable; 
create column family data;" | ~/fab/cassandra/bin/cassandra-cli -h node1
...
echo "Run..."
bin/ycsb run cassandra-10 -s -P workloads/ryan_couchbase > trials/cassandra/cass.$TRIAL.thrift.uniform.run.out 2> trials/cassandra/cass.$TRIAL.thrift.uniform.run.err
